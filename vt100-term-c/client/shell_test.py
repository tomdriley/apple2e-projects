...
SHELL_TESTS = [
    ...
    ("tabs",      r"printf 'A\tB\tC\r\n'",
     [("has", "A"), ("has", "B"), ("has", "C")]),
    ("columns",   r"printf '%-8s|%-8s|\r\n' LEFT RIGHT",
     [("has", "LEFT"), ("has", "RIGHT")]),
    ("sort",      r"printf 'banana\ncherry\napple\n' | sort",
     [("row", 1, "apple"), ("row", 2, "banana"), ("row", 3, "cherry")]),
    ("ls_root",   "ls /",
     [("has", "bin"), ("has", "etc"), ("has", "usr")]),
    ("ls_la",     "ls -la / | head -15",
     [("has", "total"), ("has", "etc")]),
    ("scroll",    r"printf 'FIRSTLINE\n'; seq 2 40",
     [("absent", "FIRSTLINE"), ("has", "40")]),
    ("scroll_heavy", "seq 1 60",
     [("has", "60"), ("has", "59")]),
    ("tput",      "tput cup 6 10; echo DEEP",
     [("row", 7, "DEEP")]),
    ...
    ("statusbar", r"printf '\033[2J\033[24;1H\033[7mSTATUSLINE\033[0m\033[1;23r\033[1;1H'; seq 1 30",
     [("row", 24, "STATUSLINE"), ("has", "30")]),
